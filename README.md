<a id="cn-version"></a>
# Anti3D-Overlay (防 3D 晕动症叠加引导工具) | [English Version](#en-version)
...
<a id="cn-features"></a>
## 🌟 核心功能 | [English Version](#en-features)
...
8. **预设管理系统（Preset Settings）**：
   * 支持将当前所有滑块、颜色 and 开关保存为自定义的“预设方案”，并在多套方案间一键应用或删除。
...
<a id="cn-install"></a>
## 🛠️ 安装与依赖 | [English Version](#en-install)
...
<a id="cn-run"></a>
## 🚀 运行与使用说明 | [English Version](#en-run)
...
<a id="en-version"></a>
# Anti3D-Overlay (Anti-3D Motion Sickness Helper) | [中文版](#cn-version)
...
<a id="en-install"></a>
## 🛠️ Installation and Dependencies | [中文版](#cn-install)
